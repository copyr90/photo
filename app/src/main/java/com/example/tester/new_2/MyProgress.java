...
public class MyProgress  extends View {
    ...
    private  static final int DEFAULT_PROGRESS_PAINT_COLOR = 0xffffcc00;		// 默认增量进度条画笔颜色
    private  static final int DEFAULT_INITIALPROGRESS_PAINT_COLOR = 0xffffccff;	// 默认本包进度条颜色
    ...
    public Paint.Style mProgressPaintStyle = Paint.Style.STROKE;			// 进度条画笔样式
    ...
    private void init()
    {
        ...
        mProgressPaints.setStyle(Paint.Style.STROKE);
        mProgressPaints.setStrokeWidth(mPaintWidth);
        mProgressPaints.setColor(mProgressColor);
        ...
        mInitialProgressPaint.setStyle(Paint.Style.STROKE);
        mInitialProgressPaint.setStrokeWidth(mPaintWidth);
        mInitialProgressPaint.setColor(0xffffccff);
